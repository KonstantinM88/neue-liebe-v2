...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.neueliebe-nebra.de/en/events',
    languages: {
  ...
  openGraph: {
    ...
    url: 'https://www.neueliebe-nebra.de/en/events',
    locale: 'en_US',
...
const eventsPageStructuredData = buildEventsStructuredData('en', 'https://www.neueliebe-nebra.de/en/events')
...
const breadcrumbStructuredData = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 2,
      name: 'Events',
      item: 'https://www.neueliebe-nebra.de/en/events',
    },
  ],
}

const faqStructuredData = buildFaqPageStructuredData('events', 'en', 'https://www.neueliebe-nebra.de/en/events')

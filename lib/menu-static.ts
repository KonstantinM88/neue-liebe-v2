...
export const MENU_PLACEHOLDER_DESKTOP = '/cafe_interior_1600x1200_optimized.webp'
export const MENU_PLACEHOLDER_MOBILE = '/cafe_interior_800x600_optimized.webp'

export const STATIC_MENU_CATEGORIES: MenuCategory[] = [
...
export const STATIC_MENU_DISHES: MenuDish[] = [
  {
    id: 'soljanka',
